  ...
  override fun <T : ViewModel> create(modelClass: KClass<T>, extras: CreationExtras): T {
    ...
    if (provider != null && assistedFactory != null) {
      throw IllegalStateException(
        "Found $modelClass in both viewModels and assistedViewModels provider multi-bindings"
      )
    }
    ...
    if (provider != null) {
      if (creationCallback != null) {
        throw IllegalStateException(
          "Found creation callback but $modelClass does not have an assisted factory"
        )
      }
    ...
    throw IllegalStateException(
      "No provider for $modelClass found in the viewmodel provider multi-binding"
    )
  }
